...
Эстетичный темный интерфейс с глубоким неоновым свечением, плавными анимациями дрейфующих колец на фоне и крупной, цепляющей типографикой.
> 📌 *Инструкция: Сделайте скриншот верхней части сайта на ПК или телефоне, назовите его `main_hero.png` и положите в репозиторий.*

![Главный экран проекта](main_hero.png)
...
> 📌 *Инструкция: Сделайте скриншот раздела «Установка» с активной вкладкой вашей ОС, назовите его `installation_tabs.png`.*
...
> 📌 *Инструкция: Сделайте скриншот плитки с карточками библиотек или таблицы команд, назовите его `commands_cards.png`.*
...
*   🎨 **Трендовый дизайн:** Эффект матового стекла (Glassmorphism), мягкие градиентные свечения, кастомные hover-эффекты и профессионально подобранные шрифты (`Unbounded` и `Manrope`).
...
Если вы хотите запустить этот справочник у себя на компьютере без интернета:
1. Клонируйте репозиторий:
   ```bash
   git clone [https://github.com/pashafox569/ffmpeg-guide.git](https://github.com/pashafox569/ffmpeg-guide.git)
